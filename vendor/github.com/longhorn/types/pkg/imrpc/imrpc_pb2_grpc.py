...
class ProcessManagerService(object):
    ...
    def ProcessCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/ProcessCreate',
    ...
    def ProcessDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/ProcessDelete',
    ...
    def ProcessGet(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/ProcessGet',
    ...
    def ProcessList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/ProcessList',
    ...
    def ProcessLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/imrpc.ProcessManagerService/ProcessLog',
    ...
    def ProcessWatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/imrpc.ProcessManagerService/ProcessWatch',
    ...
    def ProcessReplace(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/ProcessReplace',
    ...
    def VersionGet(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/imrpc.ProcessManagerService/VersionGet',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
