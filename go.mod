...
replace (
	github.com/longhorn/go-common-libs => github.com/COLDTURNIP/longhorn-go-common-libs v0.0.0-20260902114220-f588954a78f0
	github.com/longhorn/longhorn-spdk-engine => github.com/COLDTURNIP/longhorn-spdk-engine v0.0.0-20260902115033-ff73eed8104b
	github.com/longhorn/types => github.com/COLDTURNIP/longhorn-types v0.0.0-20260901081106-f341181aebaf
)
