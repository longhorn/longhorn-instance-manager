...
require (
	...
	github.com/longhorn/longhorn-engine v1.8.0-dev-20241215.0.20241227155522-358e501ffccc
	github.com/longhorn/longhorn-spdk-engine v0.0.0-20241227154304-5631393ec5a8
